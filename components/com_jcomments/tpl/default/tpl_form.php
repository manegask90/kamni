...
<p>
	<span>
		<label for="comments-form-name"><?php //echo $text; ?><span style="color:red">*</span>Имя:</label>
...
<p>
	<span>
		<label for="comments-form-email"><?php //echo $text; ?>E-mail:</label>
...
<p>
	<span>
        <label for="comments-form-comment"><span style="color:red">*</span>Текст:</label>
		<textarea id="comments-form-comment" name="comment" cols="50" rows="10" tabindex="5"></textarea>
	</span>
</p>
<?php
