...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-inline1">
	...
	<div class="userdata">
		...
		<?php endif; ?>
        <div class="text-reg">
            <p>Если вы уже зарегистрированы на нашем сайте, но забыли пароль<br>
                или Вам не пришло письмо подтверждения, воспользуйтесь формой <a href="<?php echo JRoute::_('index.php?option=com_users&view=reset'); ?>">
